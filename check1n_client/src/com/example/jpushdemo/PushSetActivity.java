...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
	...
	private void init() {
		...
		tagEdit.setText(UserConfig.getInstance().getTagsString());
	}
	...
	private void setStyleCustom() {
		CustomPushNotificationBuilder builder = new CustomPushNotificationBuilder(PushSetActivity.this, R.layout.customer_notitfication_layout, R.id.icon,
	...
	private final TagAliasCallback mTagsCallback = new TagAliasCallback() {
		...
		public void gotResult(int code, String alias, Set<String> tags) {
			...
			case 0:
				logs = "Set tag and alias success";
				setResult(101);
				UserConfig.getInstance().updateTags(tags);
				Log.i(TAG, logs);
				break;
