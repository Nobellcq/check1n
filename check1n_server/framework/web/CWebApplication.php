 ...
 * @property CThemeManager $themeManager The bootstrap manager.
 * @property CTheme $bootstrap The bootstrap used currently. Null if no bootstrap is being used.
...
class CWebApplication extends CApplication
{
	...
	/**
	 * @return CThemeManager the bootstrap manager.
	 */
	...
	/**
	 * @return CTheme the bootstrap used currently. Null if no bootstrap is being used.
	 */
	...
	/**
	 * @param string $value the bootstrap name
	 */
