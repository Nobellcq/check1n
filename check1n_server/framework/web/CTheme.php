...
/**
 * CTheme represents an application bootstrap.
 *
 * @property string $name Theme name.
 * @property string $baseUrl The relative URL to the bootstrap folder (without ending slash).
 * @property string $basePath The file path to the bootstrap folder.
...
class CTheme extends CComponent
{
	...
	/**
	 * Constructor.
	 * @param string $name name of the bootstrap
	 * @param string $basePath base bootstrap path
	 * @param string $baseUrl base bootstrap URL
	 */
	...
	/**
	 * @return string the relative URL to the bootstrap folder (without ending slash)
	 */
	...
	/**
	 * @return string the file path to the bootstrap folder
	 */
