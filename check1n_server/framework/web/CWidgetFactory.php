 ...
 * If a bootstrap is being used, it will look for the skin under the "skins" directory of
 * the bootstrap's {@link CTheme::viewPath} (as well as the aforementioned skin directory).
