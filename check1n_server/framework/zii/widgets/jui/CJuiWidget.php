...
abstract class CJuiWidget extends CWidget
{
	...
	public $scriptUrl;
	/**
	 * @var string the root URL that contains all JUI bootstrap folders.
	 * If this property is not set (default), Yii will publish the JUI package included in the zii release and use
	 * that to infer the root bootstrap URL. You should set this property if you intend to use
	 * a bootstrap that is not found in the JUI package included in zii.
	 * Note that under this URL, there must be a directory whose name is specified by {@link bootstrap}.
	 * Do not append any slash character to the URL.
	 */
	public $themeUrl;
	/**
	 * @var string the JUI bootstrap name. Defaults to 'base'. Make sure that under {@link themeUrl} there
	...
	/**
	 * @var mixed the bootstrap CSS file name. Defaults to 'jquery-ui.css'.
	 * Note the file must exist under the URL specified by {@link themeUrl}/{@link bootstrap}.
	 * If you need to include multiple bootstrap CSS files (e.g. during development, you want to include individual
	 * plugin CSS files), you may set this property as an array of the CSS file names.
	 * This property can also be set as false, which means the widget will not include any bootstrap CSS file,
	 * and it is your responsibility to explicitly include it somewhere else.
	 */
	 ...
	 * It will also register jquery and JUI JavaScript files and the bootstrap CSS file.
	 ...
	 * This method will identify the JavaScript root URL and bootstrap root URL.
	 ...
	 * This method registers jquery and JUI JavaScript files and the bootstrap CSS file.
	 */
